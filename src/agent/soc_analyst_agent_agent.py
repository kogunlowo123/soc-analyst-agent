"""SOC Analyst Agent - Main Agent Implementation."""
...
class SocAnalystAgentAgent:
    ...
    def __init__(self):
        ...
        self.alert_triage_enabled = True
        self.ioc_enrichment_enabled = True
        self.event_correlation_enabled = True
        self.playbook_generation_enabled = True
        self.incident_reporting_enabled = True
        self._tool_dispatch = {
            "triage_alert": self.tools.triage_alert,
            "enrich_ioc": self.tools.enrich_ioc,
            "correlate_events": self.tools.correlate_events,
            "query_siem": self.tools.query_siem,
            "generate_investigation": self.tools.generate_investigation,
            "create_incident_report": self.tools.create_incident_report,
        }
        logger.info(
            "agent_initialized",
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "query_siem": ['query', 'siem'],
            "generate_investigation": ['generate', 'investigation'],
